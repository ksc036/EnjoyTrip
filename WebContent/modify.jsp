        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
          <form id="form-modify" method="POST" action="">
           ...
           <input type = "hidden" name = "articleno" value = "${article.articleNo}">
            ...
            <div class="mb-3">
              <label for="userid" class="form-label">작성자 이메일 : </label>
              <input type="text" class="form-control" id="usereamil" value="${article.email}" readonly />
            </div>
            <div class="mb-3">
              <label for="subject" class="form-label">제목 : </label>
              <input type="text" class="form-control" id="subject" name ="title" value=" ${article.title}" />
            </div>
            <div class="mb-3">
