...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		builder.append("			<li class=\"page-item page-etc\" data-pg=\"1\"> \n");
		builder.append("				<a href=\"#\" class=\"page-link\">처음</a> \n");
		builder.append("			</li> \n");
		builder.append("			<li class=\"page-item page-etc\" data-pg=\"" + (this.startRange ? 1 : (startPage - 1)) + "\"> \n");
		...
		builder.append("			<li class=\"page-item page-etc\" data-pg=\"" + (this.endRange ? endPage : (endPage + 1)) + "\"> \n");
		builder.append("				<a href=\"#\" class=\"page-link\">다음</a> \n");
		builder.append("			</li> \n");
		builder.append("			<li class=\"page-item page-etc\" data-pg=\"" + totalPageCount + "\"> \n");
